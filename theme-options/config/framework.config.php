...
// ===============================================================================================
$settings = array(
    'menu_title' => 'Every Theme',
    'menu_type' => 'menu', // menu, submenu, options, theme, etc.
    'menu_slug' => 'cs-framework',
    'ajax_save' => true,
    'show_reset_all' => false,
    'framework_title' => 'Every Theme Options',
);
...
$options[] = array(
    'name' => 'header_contact',
    'title' => 'Top Header Contact',
    'icon' => 'fa fa-star',
    'fields' => array(
        array(
            'type' => 'heading',
            'content' => 'Site Top Contact',
        ),

        array(
            'id' => 'site_top_left_contact',
            'type' => 'group',
            'title' => 'Contact Field Group',
            'button_title' => 'Add New Contact',
            'accordion_title' => 'Contact Info',
            'fields' => array(
                array(
                    'id' => 'contact_icon',
                    'type' => 'icon',
...
$options[] = array(
    ...
    'title' => 'Top Header Social Media',
    'icon' => 'fa fa-star',
    'fields' => array(
        array(
            'type' => 'heading',
            'content' => 'Site Top Social Media',
        ),

        array(
            'id' => 'site_top_right_social_media',
            'type' => 'group',
            'title' => 'Social Media Field Group',
            'button_title' => 'Add New Social Media',
            'accordion_title' => 'Social Media Info',
            'fields' => array(
                array(
...
// ------------------------------
// start option section for About    -
// ------------------------------
$options[] = array(
	'name' => 'about_section',
	'title' => 'About Section',
	...
	'fields' => array(
		...
		array(
			'type' => 'heading',
			'content' => 'Left Feature Section',
		),	
		array(
			'id'=>'left_feature_image',
			'type'=>'image',
...
$options[] = array(
	...
	'fields' => array(
		...
		array(
			...
			'type'=>'group',
			'title'=>'Team Section Group',
			'button_title'=>'Add New Member Item',
			'accordion_title'=>'Member Item',
			'fields'=>array(
				array(
					'id'=>'team_member_name',
					'type'=>'text',
		...
		array(
			'id'=>'team_overlay_color',
			'type'=>'color_picker',
			'title'=>'Team Overlay Color',
			'default'=>'#000',
		),
	),
);
// ------------------------------
// end option section for Team    -
// ------------------------------
...
// ------------------------------
// start option section for Testimonial    -
// ------------------------------
...
$options[] = array(
	...
	'fields' => array(
		...
		array(
			...
			'accordion_title' => 'Testimonial Item',
			'fields' => array(
				array(
					'id' => 'slider_image',
					'type' => 'image',
...
// ------------------------------
// end option section for Testimonial    -
// ------------------------------
